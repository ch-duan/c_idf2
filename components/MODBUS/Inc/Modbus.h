...
typedef struct {
  ...
  osMessageQueueId_t slave_queue_handle;
...
uint8_t RingGetNBytes(modbusRingBuffer_t *xRingBuffer, uint8_t *buffer,
                      uint8_t uNumber);                   // gets uNumber of bytes from ring buffer, returns the actual number of bytes read

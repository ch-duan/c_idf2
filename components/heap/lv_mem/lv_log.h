...
#define LV_LOG_TRACE(...) LV_LOG_T(__VA_ARGS__)
#define LV_LOG_INFO(...)  LV_LOG_T(__VA_ARGS__)
#define LV_LOG_WARN(...)  LV_LOG_T(__VA_ARGS__)
#define LV_LOG_ERROR(...) LV_LOG_T(__VA_ARGS__)
#define LV_LOG_USER(...)  LV_LOG_T(__VA_ARGS__)
#endif /*LV_USE_LOG*/

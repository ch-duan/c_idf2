...
enum QMI8658Register {
  ...
  QMI8658_REG_WHOAMI = 0,  // 0
  /*! \brief FIS hardware revision register. */
  QMI8658_REG_REVISION,  // 1
  ...
  QMI8658_REG_FIFOCTRL = 19,
  /*! \brief FIFO data register. */
  QMI8658_REG_FIFODATA,  // 20
  /*! \brief FIFO status register. */
  QMI8658_REG_FIFOSTATUS,  // 21
  /*! \brief Output data overrun and availability. */
  QMI8658_REG_STATUSINT = 45,
  /*! \brief Output data overrun and availability. */
  QMI8658_REG_STATUS0,
  /*! \brief Miscellaneous status register. */
  QMI8658_REG_STATUS1,
  /*! \brief timestamp low. */
  QMI8658_REG_TIMESTAMP_L = 48,
  /*! \brief timestamp low. */
  QMI8658_REG_TIMESTAMP_M,
  /*! \brief timestamp low. */
  QMI8658_REG_TIMESTAMP_H,
  /*! \brief tempearture low. */
  QMI8658_REG_TEMPEARTURE_L = 51,
  /*! \brief tempearture low. */
  QMI8658_REG_TEMPEARTURE_H,
  ...
  QMI8658_REG_AEREG1 = 87,
  /*! \brief AttitudeEngine overflow flags. */
  QMI8658_REG_AEOVERFLOW,

  QMI8658_REG_I2CM_STATUS = 110
};
...
enum QMI8658_Ois_Register {
  ...
  QMI8658_REG_RESET = 0x60,  // 96  [0x60]
};
